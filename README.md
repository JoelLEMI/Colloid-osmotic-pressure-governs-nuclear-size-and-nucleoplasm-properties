...
This folder contains three example raw data files (TIFF images of cells) and a subfolder named `Data`, which contains:
...
- The final CSV table of all measurements from the 42 cells TIFF file: `JL396-1.csv`
